...
En trabajo rural informal, el cosechero muchas veces arranca sin garantia real de que el pago prometido exista. El acuerdo depende de confianza verbal, mensajes sueltos o promesas que no tienen respaldo verificable.

Eso genera tres problemas concretos:

- el empleador puede prometer sin inmovilizar fondos
...
CosechaPay hace una cosa simple, pero poderosa: **bloquea el pago antes de que empiece el trabajo**.
...
La clave conceptual es esta: el core del producto NO depende de Soroban. El escrow real vive en **Claimable Balances nativos**. Soroban se suma como una capa extra de verificabilidad, no como punto critico del happy path.
...
- **Mas narrativa para el track**: Soroban aparece visible, pero sin poner en peligro la UX principal
...
- la UI muestra estado, hash y tx de Soroban solo si existen
...
6. el cosechero entra con su wallet
7. reclama el balance
8. todo queda verificable on-chain
